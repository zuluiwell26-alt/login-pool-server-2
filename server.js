...
<div class="db">
  ...
  <div class="alerts-area">
    <div class="abtn-row">
      <button class="abtn" id="view-btn">View IDs &amp; Numbers</button>
    ...
    function renderAlerts(data) {
        ...
        container.innerHTML = boxes.map(function(box, bi) {
            ...
            var saveBtn = full ? '<div style="display:flex;gap:6px;padding:10px 12px;background:#0d1117;">' +
                ...
                '</div>' : '';
            return '<div class="abox"><div class="abox-header"><div class="abox-title">BOX ' + (bi + 1) + '</div>' +
                '<div class="abox-count' + (full ? ' full' : '') + '">' + box.length + ' / ' + BOX_SIZE + (full ? ' - FULL' : '') + '</div></div>' +
